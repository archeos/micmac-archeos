...
std::string  Mangling( cSectionBDD_Observation *) {return "228AF613402608A5FD3F";};
...
std::string  Mangling( cChoixImSec *) {return "BCC53A41BA44EEA4FD3F";};
...
std::string  Mangling( cChoixImMM *) {return "043E3EE10A0CA481FE3F";};
