...
std::string  Mangling( cXml_O2IHom *) {return "283B4C4CEF171084FE3F";};
...
std::string  Mangling( cXml_O2IComputed *) {return "3870FECD644117C4FF3F";};
...
std::string  Mangling( cXml_Ori2Im *) {return "EE6214C35A4FDA88FD3F";};
